...
SHARED_SUBJECTS: dict[str, dict] = {
    ...
    "biochemistry": {
        ...
        "name_zh": "生物化学",
        "exams": ["NMAT", "MCAT"],
        "summary": "两边都会碰到：NMAT 多挂在 Chemistry；MCAT 在 Bio/Biochem 与 Chem/Phys 都有高权重。",
        "nmat_role": "主要落在 NMAT Chemistry 的 biochemistry 范围",
        "mcat_role": "MCAT Bio/Biochem 与 Chem/Phys 的核心交叉内容",
        "scope": [
        ...
        "exam_notes": {
            "NMAT": "不单独成卷，按 Chemistry 导论生化基本概念准备。",
            "MCAT": "高频独立知识块；建议单开专题深挖。",
        },
    },
}
...
MCAT: dict = {
    ...
    "name_zh": "北美医学院入学考试",
    "admin": "AAMC",
    "format": "四个官方科目；科学三科各约 59 题 / 95 分钟，CARS 53 题 / 90 分钟。顺序固定。",
    "sections": [
        {
            "slug": "chem-phys",
